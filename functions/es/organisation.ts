class MetaService {
	private context: any;
	private title = `WhyDonate: Plataforma Crowdfunding ONG y Recaudar Dinero`;
	private description = `WhyDonate es la Mejor Plataforma de Crowdfunding ONG para Recaudar Dinero. ¡Empiece una recaudación de fondos gratuita!`;
	private url = `https://whydonate.com/es/organisation`;
	...
	constructor(context: any) {
		...
		this.url = 'https://' + host + '/es/organisation';
	}
	get getTitle() {
		return this.title;
	}
