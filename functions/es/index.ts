class MetaService {
	private context: any;
	private title = `WhyDonate: Plataforma Crowdfunding Social y Recaudar Dinero`;
	private description = `WhyDonate es la Mejor Plataforma de Crowdfunding Social para Recaudar Dinero. ¡Empiece una recaudación de fondos gratuita!`;
	private url = `https://whydonate.com/es/`;
