class MetaService {
	private context: any;
	private title = `Busque Colectas de Fondos | Whydonate`;
	private description = `¿Se siente generoso? Descubra su colecta de fondos favorita en Whydonate, la mejor plataforma de crowdfunding para individuos y ONGs.`;
	private url = `https://whydonate.com/es/search`;
