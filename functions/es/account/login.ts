class MetaService {
	private context: any;
	private title = `Iniciar sesión | Whydonate`;
	private description = `Junte fondos para su causa en Whydonate, la mejor plataforma de crowdfunding para individuos y organizaciones.`;
	private url = `https://whydonate.com/es/account/login`;
	...
	constructor(context: any) {
		...
		this.url = 'https://' + host + '/es/account/login';
	}
	get getTitle() {
		return this.title;
	}
