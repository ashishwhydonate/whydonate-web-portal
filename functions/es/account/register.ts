class MetaService {
	private context: any;
	private title = `Registrar Cuenta | Whydonate`;
	private description = `¿Busca recaudar dinero para una causa? ¡No busque más! Comience una recolección de fondos exitosa en Whydonate, el mejor sitio de crowdfunding para individuos y organizaciones.`;
	private url = `https://whydonate.com/es/account/register`;
	...
	constructor(context: any) {
		...
		this.url = 'https://' + host + '/es/account/register';
	}
	get getTitle() {
		return this.title;
	}
