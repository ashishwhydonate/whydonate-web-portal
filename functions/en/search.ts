class MetaService {
	private context: any;
	private title = `Search Fundraisers | Whydonate`;
	private description = `Feeling generous? Discover your favourite fundraiser on Whydonate, the best crowdfunding platform for individuals and NGOs.`;
	private url = `https://whydonate.com/en/search`;
