class MetaService {
	private context: any;
	private title = `Charity Fundraising & Best Crowdfunding site for Charity`;
	private description = `Whydonate is the Best Fundraising and Crowdfunding site for Charity. Raise money for charity on Whydonate for free!`;
	private url = `https://whydonate.com/en/organisation`;
	...
	constructor(context: any) {
		...
		this.url = 'https://' + host + '/en/organisation';
	}
	get getTitle() {
		return this.title;
	}
