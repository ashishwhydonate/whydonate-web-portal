class MetaService {
	private context: any;
	private title = `WhyDonate: Personal Crowdfunding and Charity Fundraising`;
	private description = `WhyDonate is the Best Crowdfunding Platform and Fundraising Site for Charity and Personal use. Raise Money for Charity and Individuals for Free!`;
	private url = `https://whydonate.com/en/`;
