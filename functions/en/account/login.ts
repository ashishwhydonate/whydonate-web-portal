class MetaService {
  private context: any;
	private title = `Login | Whydonate`;
	private description = `Raise funds for your cause on Whydonate, the best online crowdfunding platform for individuals and organizations.`;
	private url = `https://whydonate.com/en/account/login`;
	...
	constructor(context: any) {
		...
		this.url = 'https://' + host + '/en/account/login';
	}
	get getTitle() {
		return this.title;
	}
