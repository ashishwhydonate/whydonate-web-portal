class MetaService {
	private context: any;
	private title = `Register Account | Whydonate`;
	private description = `Looking to raise money for a cause? Look no further! Start a successful fundraiser on Whydonate, the top crowdfunding site for individuals and organizations.`;
	private url = `https://whydonate.com/en/account/register`;
	...
	constructor(context: any) {
		...
		this.url = 'https://' + host + '/en/account/register';
	}
	get getTitle() {
		return this.title;
	}
