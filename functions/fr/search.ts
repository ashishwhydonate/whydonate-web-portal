class MetaService {
	private context: any;
	private title = `Rechercher campagnes | Whydonate`;
	private description = `Vous vous sentez généreux ? Découvrez votre collecte de fonds préférée sur Whydonate, la meilleure plateforme de financement par la foule pour les particuliers et les ONG.`;
	private url = `https://whydonate.com/fr/search`;
