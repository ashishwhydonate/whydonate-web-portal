class MetaService {
	private context: any;
	private title = `Whydonate: 1# Plateforme Crowdfunding Association`;
	private description = `Whydonate est la meilleure Plateforme Crowdfunding Association pour la Collecte de Fonds. Gratuit Financement Participatif !`;
	private url = `https://whydonate.com/fr/organisation`;
	...
	constructor(context: any) {
		...
		this.url = 'https://' + host + '/fr/organisation';
	}
	get getTitle() {
		return this.title;
	}
