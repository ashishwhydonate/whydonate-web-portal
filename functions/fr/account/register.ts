class MetaService {
	private context: any;
	private title = `Enregistrer un compte | Pourquoi donner`;
	private description = `Vous cherchez à collecter des fonds pour une cause ? Ne cherchez plus ! Lancez une collecte de fonds réussie sur Whydonate, le premier site de financement par la foule pour les particuliers et les organisations.`;
	private url = `https://whydonate.com/fr/account/register`;
	...
	constructor(context: any) {
		...
		this.url = 'https://' + host + '/fr/account/register';
	}
	get getTitle() {
		return this.title;
	}
