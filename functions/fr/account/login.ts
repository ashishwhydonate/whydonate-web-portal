class MetaService {
	private context: any;
	private title = `Se connecter | Whydonate`;
	private description = `Collectez des fonds pour votre cause sur Whydonate, la meilleure plateforme de crowdfunding en ligne pour les particuliers et les organisations.`;
	private url = `https://whydonate.com/fr/account/login`;
	...
	constructor(context: any) {
		...
		this.url = 'https://' + host + '/fr/account/login';
	}
	get getTitle() {
		return this.title;
	}
