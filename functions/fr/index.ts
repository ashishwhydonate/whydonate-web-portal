class MetaService {
	private context: any;
	private title = `Whydonate: 1# Plateforme Crowdfunding et Collecte de Fonds`;
	private description = `Whydonate est la meilleure Plateforme Crowdfunding pour la Collecte de Fonds. Gratuit Financement Participatif pour Association ou Particulier !`;
	private url = `https://whydonate.com/fr/`;
