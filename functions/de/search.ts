class MetaService {
	private context: any;
	private title = `Suche Spendenaktionen | Whydonate`;
	private description = `Fühlen Sie sich großzügig? Entdecken Sie Ihre Lieblings-Spendenaktion auf Whydonate, der besten Crowdfunding-Plattform für Einzelpersonen und NGOs.`;
	private url = `https://whydonate.com/de/search`;
