class MetaService {
	private context: any;
	private title = `Crowdfunding Soziale Projekte & Spenden für Verein Sammeln`;
	private description = `WhyDonate ist die beste Crowdfunding Soziale Projekte Plattform um Spenden fur Verein zu Sammeln. Starten Sie eine kostenlose Spendenaktion!`;
	private url = `https://whydonate.com/de/organisation`;
	...
	constructor(context: any) {
		...
		this.url = 'https://' + host + '/de/organisation';
	}
	get getTitle() {
		return this.title;
	}
