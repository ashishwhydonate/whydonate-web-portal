class MetaService {
	private context: any;
	private title = `WhyDonate: Spenden Sammeln & Crowdfunding Plattform`;
	private description = `WhyDonate ist die besten Spenden Sammeln & Crowdfunding Plattform für ihren Spendenaktion. Starten Sie eine kostenlose Spendenaktion!`;
	private url = `https://whydonate.com/de/`;
