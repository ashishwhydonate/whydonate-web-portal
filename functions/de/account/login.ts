class MetaService {
	private context: any;
	private title = `Anmelden | Whydonate`;
	private description = `Sammeln Sie Spenden für Ihre Zwecke auf Whydonate, der besten Online-Crowdfunding-Plattform für Einzelpersonen und Unternehmen.`;
	private url = `https://whydonate.com/de/account/login`;
	...
	constructor(context: any) {
		...
		this.url = 'https://' + host + '/de/account/login';
	}
	get getTitle() {
		return this.title;
	}
