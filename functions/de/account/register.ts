class MetaService {
	private context: any;
	private title = `Konto registrieren | Whydonate`;
	private description = `Möchten Sie Geld für einen bestimmten Zweck sammeln? Suchen Sie nicht weiter! Starten Sie eine erfolgreiche Spendenaktion auf Whydonate, der wichtigsten Crowdfunding-Site für Einzelpersonen und Organisationen.`;
	private url = `https://whydonate.com/de/account/register`;
	...
	constructor(context: any) {
		...
		this.url = 'https://' + host + '/de/account/register';
	}
	get getTitle() {
		return this.title;
	}
