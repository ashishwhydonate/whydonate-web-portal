class MetaService {
	private context: any;
	private title = `Inloggen | Whydonate`;
	private description = `Login op je Whydonate account om alle inzamelingsacties en donaties in te zien. Download overzichten en beheer alle inzamelingsacties.`;
	private url = `https://whydonate.com/nl/account/login`;
	...
	constructor(context: any) {
		...
		this.url = 'https://' + host + '/nl/account/login';
	}
	get getTitle() {
		return this.title;
	}
