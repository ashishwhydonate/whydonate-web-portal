class MetaService {
	private context: any;
	private title = `Registreer Account | Whydonate`;
	private description = `Start gratis een Crowdfunding Inzamelingsactie als Particulier of Goed Doel en zamel Online Donaties in op het beste Crowdfunding Platform van Nederland!`;
	private url = `https://whydonate.com/nl/account/register`;
	...
	constructor(context: any) {
		...
		this.url = 'https://' + host + '/nl/account/register';
	}
	get getTitle() {
		return this.title;
	}
