class MetaService {
	private context: any;
	private title = `Zoek inzamelingsactie | Whydonate`;
	private description = `Vind het Goede doel wat bij jou past en Geef! Zoek door de lijst met alle goede doelen in Nederland en doneer aan de stichting die jij het beste vindt.`;
	private url = `https://whydonate.com/nl/search`;
