class MetaService {
	private context: any;
	private title = `Geld inzamelen & Crowdfunding voor Goed doel & Particulier`;
	private description = `Online Geld inzamelen voor jezelf of iemand anders. De beste Crowdfunding & Fondsenwerving Site voor Particulieren & Goede doelen!`;
	private url = `https://whydonate.com/nl/`;
